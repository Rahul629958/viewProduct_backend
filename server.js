...
const configuration = new Configuration({
  apiKey: "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",
...
// const responseFromOpenAI =  openai.createCompletion({
//   model: "text-davinci-003",
//   prompt: "Title: " + scrapedData.Title+ ", Highlight: "+scrapedData.Highlights+
//   ", Description: "+scrapedData.Description+
//   "\n output honestly single digit rating from 0 to 10, for title, highlight, description of the product.",
//   temperature: 0.1,
//   max_tokens: 50,
//   top_p: 1,
//   frequency_penalty: 0,
//   presence_penalty: 0,
// });
const response = {Name: "ONly me"};
// const val = JSON.parse("{ "+ responseFromOpenAI + "}");
// console.log(val);
return response;
}
